...
namespace Game4
{
    ...
    public class Cube
    {
        ...
        public void InitializeVertices()
        {
            ...
            new VertexPositionColor() { Position = new Vector3(-.1f,  .1f, -.1f), Color = Color.Lavender },
            new VertexPositionColor() { Position = new Vector3( .1f,  .1f, -.1f), Color = Color.MediumPurple },
            new VertexPositionColor() { Position = new Vector3(-.1f, -.1f, -.1f), Color = Color.Purple },
            new VertexPositionColor() { Position = new Vector3( .1f, -.1f, -.1f), Color = Color.Plum },
            new VertexPositionColor() { Position = new Vector3(-.1f,  .1f,  .1f), Color = Color.Lavender },
            new VertexPositionColor() { Position = new Vector3( .1f,  .1f,  .1f), Color = Color.MediumPurple },
            new VertexPositionColor() { Position = new Vector3(-.1f, -.1f,  .1f), Color = Color.Purple },
            new VertexPositionColor() { Position = new Vector3( .1f, -.1f,  .1f), Color = Color.Plum }
