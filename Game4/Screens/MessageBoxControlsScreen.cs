...
namespace Game4.Screens
{
    ...
    public class MessageBoxControlsScreen : GameScreen
    {
        ...
        public MessageBoxControlsScreen(string message, bool includeUsageText = true)
        {
            const string usageText = "\nWASD or Arrow Keys to move" +
                                    "\nLeft Shift to Shoot Rocket" +
                                    "\nPress Space or Enter to Exit Menu";
